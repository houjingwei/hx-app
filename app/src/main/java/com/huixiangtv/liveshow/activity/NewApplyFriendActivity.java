...
public class NewApplyFriendActivity extends BaseBackActivity {
    ...
    NewApplyFriendAdapter adapter ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_new_apply_friend);
        x.view().inject(this);
        initView();
        loadData();
    }
    ...
    private void loadData() {
        ...
        RequestUtils.sendPostRequest(Api.APPLY_ADD_ME_LIST, params, new ResponseCallBack<Friend>() {
            ...
            public void onFailure(ServiceException e) {
                CommonHelper.showTip(NewApplyFriendActivity.this,e.getMessage());
            }
        }, Friend.class);
    }
    ...
    private void initView() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ForwardUtils.target(NewApplyFriendActivity.this, Constant.CHAT_MSG,null);
            }
        });

        adapter = new NewApplyFriendAdapter(NewApplyFriendActivity.this);
    ...
    private void initSwipeMenu() {
        ...
        SwipeMenuCreator creator = new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                // create "delete" item
                SwipeMenuItem deleteItem = new SwipeMenuItem(NewApplyFriendActivity.this);
                // set item background
                deleteItem.setBackground(new ColorDrawable(Color.rgb(248,
                        79, 130)));
                // set item width
                deleteItem.setWidth(WidgetUtil.dip2px(NewApplyFriendActivity.this,60));
                // set a icon
        ...
        mListView.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                ...
                switch (index) {
                    case 0:
                        CommonHelper.showTip(NewApplyFriendActivity.this,"delete"+f.getNickName());
                        break;
                }
                return false;
            }
