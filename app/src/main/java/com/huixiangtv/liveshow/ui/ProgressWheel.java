...
public class ProgressWheel extends View {
	...
	private void parseAttributes(TypedArray a) {
		...
		delayMillis = a.getInteger(R.styleable.ProgressWheel_pw_delayMillis, delayMillis);
		if (delayMillis < 0) {
			delayMillis = 0;
		}
		...
		textColor = a.getColor(R.styleable.ProgressWheel_pw_textColor, textColor);
		...
		circleColor = a.getColor(R.styleable.ProgressWheel_pw_circleColor, circleColor);
