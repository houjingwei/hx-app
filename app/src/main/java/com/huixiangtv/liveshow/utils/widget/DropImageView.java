...
public class DropImageView extends ImageView implements OnTouchListener,
    ...
    public interface DropImageViewListener {
        ...
        void onClick(DropImageView v);

        boolean onMove(DropImageView v, MotionEvent e1, MotionEvent e2);

        void onLongClick(DropImageView v);

        void onUp(DropImageView v);
