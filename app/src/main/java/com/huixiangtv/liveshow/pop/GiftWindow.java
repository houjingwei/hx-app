...
import com.huixiangtv.liveshow.adapter.GiftAdapter;
import com.huixiangtv.liveshow.message.MessageBase;
import com.huixiangtv.liveshow.model.Gift;
import com.huixiangtv.liveshow.model.Live;
import com.huixiangtv.liveshow.model.Post;
...
public class GiftWindow extends BasePopupWindow implements OnClickListener {
    ...
    public GiftWindow(Activity context, int width, int height,Live live,TextView hot) {
    ...
    public void initPopUpWindow() {
        try {
            view = RelativeLayout.inflate(context, R.layout.pop_gift, null);
    ...
    private void initGiftPanel() {
        ...
        for (int i = 0; i < giftViewCount; i++) {
            View dataView = LayoutInflater.from(activity).inflate(R.layout.gift_list_view, null);
            GridView gvGiftView = (GridView) dataView.findViewById(R.id.gvGift);
