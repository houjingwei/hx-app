...
import com.huixiang.live.pop.ShareWindow;
import com.huixiang.live.utils.CommonHelper;
...
public class LiveView extends RelativeLayout implements View.OnClickListener {
    ...
    private void changeHanhua() {
        ...
        if ("shouting_yes".equals(triggerTag)) {
            ...
            //非喊话状态
            gd.setColor(getResources().getColor(R.color.orange));
            switchLabel.setTextColor(getResources().getColor(R.color.orange));
